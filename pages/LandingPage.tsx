...
const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 p-4">
      ...
      <h2 className="text-3xl font-semibold max-w-lg text-center mb-4 text-primary-pink">
      ...
      <p className="text-lg max-w-lg text-center mb-6 font-visby text-black">
        Discover the power of our platform and how it can revolutionize the way
        you do business. Our tools are designed with your success in mind.
      </p>
